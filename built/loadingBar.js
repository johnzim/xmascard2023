...
export function drawLoadingBar(ctx) {
    ...
    ctx.fillStyle = "#222";
    ctx.fillRect(ctx.canvas.width * 0.5 - barWidth * 0.5, ctx.canvas.height * 0.5, barWidth, 6);
    ctx.fillStyle = "white";
    ctx.fillRect(ctx.canvas.width * 0.5 - barWidth * 0.5, ctx.canvas.height * 0.5, barWidth * progressPercent, 6);
    return true;
}
